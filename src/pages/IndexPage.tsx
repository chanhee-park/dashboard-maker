...
const IndexPage = () => {
  return (
    <div>
      <h2>Index Page</h2>
      <p>This is a sample page for testing routing and scrolling.</p>
      <h3>The standard Lorem Ipsum passage, used since the 1500s</h3>
      <p>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nobis
        perspiciatis voluptate architecto reprehenderit exercitationem commodi
        amet voluptatibus, rerum, maiores iste iusto fugiat accusantium facere
        similique consectetur suscipit. Distinctio, dignissimos? Itaque!
      </p>
      <h3>
